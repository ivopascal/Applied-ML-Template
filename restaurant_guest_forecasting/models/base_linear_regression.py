...
def load_linear_regression():
    ...
    for dataframe in full_restaurant_df:
        dropped_cols_df = dataframe.drop(columns=[col for col in dataframe.columns if 
                                col.startswith('art_')])
    ...
    # Assuming X_train is a DataFrame, you can pair feature names with their coefficients
